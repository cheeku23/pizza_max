<x-admin-layout>
    <x-slot:title>Create Pizza</x-slot:title>
    <x-slot:pageTitle>Create New Pizza</x-slot:pageTitle>
    <x-slot:pageSubtitle>Add a new pizza to your menu</x-slot:pageSubtitle>
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-xl shadow-lg p-8">
            <form action="{{ url('admin/pizzas') }}" method="POST" enctype="multipart/form-data">
                @csrf
